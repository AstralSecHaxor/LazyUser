...
def coletar_informacoes():
    try:
        ...
        for infox in multi:
            ...
            elif infox == 24: pwnedOrNot()
            elif infox == 25: dnsrecon()
            elif infox == 26: zphisher()
            elif infox == 27: mrsip()
            elif infox == 28: userrecon()
            elif infox == 29: phoneinfoga()
            elif infox == 30: sitebroker()
            elif infox == 31: gathetool()
            elif infox == 32: adbtk()
            elif infox == 33: tekdefense()
            elif infox == 34: eagleeye()
            elif infox == 35: eyewitness()
            elif infox == 36: inspy()
            elif infox == 37: fierce()
            elif infox == 38: gasmask()
        ...
        print(f"\n{vlh}Ups! {bra}'{coletarinfox}' {vlh}Insira apenas números");timeout(2)
        return coletar_informacoes()
...
def analise_vulnerabilidades():
    try:
        ...
        analise_vuln = input(f"{vd}LazyUser ~$ {bra}")
        ...
        print(f"\n{vlh}Ups! {bra}'{analise_vuln}' {vlh}Insira apenas números");timeout(2)
        return analise_vulnerabilidades()
